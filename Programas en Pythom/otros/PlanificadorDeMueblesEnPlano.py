# Importamos las librerias necesarias para la interfaz grafica y manejo de imagenes
import tkinter as tk
from tkinter import ttk, messagebox
from PIL import Image, ImageTk
import json

# Definimos la clase para definir areas de habitacion
class AreaHabitacion:
    def __init__(self, nombre, x1, y1, x2, y2, tipo_habitacion):
        # Inicializamos los atributos basicos de la habitacion
        self.nombre = nombre
        self.x1 = x1
        self.y1 = y1
        self.x2 = x2
...
# Definimos la clase principal del planificador de muebles

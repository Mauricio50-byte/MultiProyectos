...
public class Ejercicio180 {
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            String edadStr = JOptionPane.showInputDialog("Ingrese la edad de la persona (ingrese un número negativo para salir):");
            ...
            String sexo = JOptionPane.showInputDialog("Ingrese el sexo de la persona (H para hombre, M para mujer):").toUpperCase();

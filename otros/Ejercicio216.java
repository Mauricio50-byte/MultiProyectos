...
public class Ejercicio216 {
    public static void main(String[] args) {
        ...
        double promedioGeneral = calcularPromedioGeneral(calificacionMatematicas, calificacionFisica, calificacionQuimica);
    ...
    private static double calcularPromedioGeneral(double calificacionMatematicas, double calificacionFisica, double calificacionQuimica) {

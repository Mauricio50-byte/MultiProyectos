...
public class Ejercicio211 {
    ...
    public static void main(String[] args) {
        // Solicitar al usuario ingresar el número de unidades consumidas de cada alimento
    ...
    private static double calcularCuentaTotal(int bocadilloJamon, int bocadilloQueso, int patatasFritas, int refresco, int cerveza) {

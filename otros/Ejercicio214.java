...
public class Ejercicio214 {
    public static void main(String[] args) {
        ...
        double porcentajePersona1 = calcularPorcentaje(inversionPersona1, inversionPersona1 + inversionPersona2 + inversionPersona3);
        double porcentajePersona2 = calcularPorcentaje(inversionPersona2, inversionPersona1 + inversionPersona2 + inversionPersona3);
        double porcentajePersona3 = calcularPorcentaje(inversionPersona3, inversionPersona1 + inversionPersona2 + inversionPersona3);
    ...
    private static double calcularPorcentaje(double cantidadPersona, double cantidadTotal) {
        // Calcular el porcentaje de inversión de una persona con respecto a la cantidad total

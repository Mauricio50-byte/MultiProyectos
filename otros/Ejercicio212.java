...
public class Ejercicio212 {
    ...
    private static double calcularCosteConsumidor(double costeTotal, double porcentajeGananciaVendedor, double porcentajeImpuesto) {
        ...
        // Calcular el coste para el consumidor sumando la ganancia del vendedor y el impuesto

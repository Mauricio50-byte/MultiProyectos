...
public class Ejercicio209 {
    public static void main(String[] args) {
        // Solicitar al usuario ingresar el número de reprobados, aprobados, notables y sobresalientes
        ...
        // Mostrar resultados
        JOptionPane.showMessageDialog(null, "Tanto por ciento de alumnos que han superado la asignatura: " + porcentajeAprobados + "%");
    ...
    private static double calcularPorcentajeReprobados(int reprobados, int aprobados, int notables, int sobresalientes) {

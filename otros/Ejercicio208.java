...
public class Ejercicio208 {
    public static void main(String[] args) {
        // Solicitar al usuario ingresar las calificaciones parciales, la de prácticas y la de asistencia
        ...
        double calificacionFinal = calcularCalificacionFinal(calificacionesParciales, calificacionPracticas, calificacionAsistencia);

        // Mostrar el resultado
        JOptionPane.showMessageDialog(null, "La calificación final es: " + calificacionFinal);
    }

    private static double calcularCalificacionFinal(double[] calificacionesParciales, double calificacionPracticas, double calificacionAsistencia) {
